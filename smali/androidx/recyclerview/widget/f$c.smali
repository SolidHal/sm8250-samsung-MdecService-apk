...
.method constructor <init>(Landroidx/recyclerview/widget/f$b;Ljava/util/List;[I[IZ)V
    ...
    .line 8
    invoke-virtual {p1}, Landroidx/recyclerview/widget/f$b;->e()I
    ...
    .line 9
    invoke-virtual {p1}, Landroidx/recyclerview/widget/f$b;->d()I
    ...
    .line 12
    invoke-direct {p0}, Landroidx/recyclerview/widget/f$c;->h()V
...
.method private b(Ljava/util/List;Landroidx/recyclerview/widget/k;III)V
    ...
    .line 2
    invoke-interface {p2, p3, p4}, Landroidx/recyclerview/widget/k;->c(II)V
    ...
    .line 8
    invoke-static {p1, v4, v0}, Landroidx/recyclerview/widget/f$c;->j(Ljava/util/List;IZ)Landroidx/recyclerview/widget/f$d;
    ...
    invoke-interface {p2, v5, p3}, Landroidx/recyclerview/widget/k;->b(II)V
    ...
    .line 12
    invoke-interface {p2, p3, v0, v1}, Landroidx/recyclerview/widget/k;->d(IILjava/lang/Object;)V

    goto :goto_2

    .line 13
    :cond_3
    invoke-interface {p2, p3, v0}, Landroidx/recyclerview/widget/k;->c(II)V
...
.method private c(Ljava/util/List;Landroidx/recyclerview/widget/k;III)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-static {p1, v4, v5}, Landroidx/recyclerview/widget/f$c;->j(Ljava/util/List;IZ)Landroidx/recyclerview/widget/f$d;
    ...
    invoke-interface {p2, v6, v7}, Landroidx/recyclerview/widget/k;->b(II)V
    ...
    .line 12
    invoke-interface {p2, v1, v0, v2}, Landroidx/recyclerview/widget/k;->d(IILjava/lang/Object;)V
    ...
    .line 13
    invoke-interface {p2, v1, v0}, Landroidx/recyclerview/widget/k;->a(II)V
...
.method private f(III)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/recyclerview/widget/f$c;->g(IIIZ)Z
...
.method private g(IIIZ)Z
    ...
    invoke-virtual {p2, v1, v0}, Landroidx/recyclerview/widget/f$b;->b(II)Z
    ...
    invoke-virtual {p1, v1, v0}, Landroidx/recyclerview/widget/f$b;->a(II)Z
    ...
    invoke-virtual {v1, v0, p2}, Landroidx/recyclerview/widget/f$b;->b(II)Z
    ...
    invoke-virtual {p3, v0, p2}, Landroidx/recyclerview/widget/f$b;->a(II)Z
    ...
    .line 12
    :cond_6
    iget v1, v2, Landroidx/recyclerview/widget/f$f;->a:I
...
.method private h()V
    ...
    .line 8
    invoke-direct {p0, v0, v1, v2}, Landroidx/recyclerview/widget/f$c;->f(III)V
    ...
    .line 9
    invoke-direct {p0, v0, v1, v2}, Landroidx/recyclerview/widget/f$c;->i(III)V
...
.method private static j(Ljava/util/List;IZ)Landroidx/recyclerview/widget/f$d;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public d(Landroidx/recyclerview/widget/k;)V
    ...
    .line 12
    invoke-direct/range {v1 .. v6}, Landroidx/recyclerview/widget/f$c;->c(Ljava/util/List;Landroidx/recyclerview/widget/k;III)V
    ...
    .line 13
    invoke-direct/range {v1 .. v6}, Landroidx/recyclerview/widget/f$c;->b(Ljava/util/List;Landroidx/recyclerview/widget/k;III)V
    ...
    .line 17
    invoke-virtual {p1, v1, v7, v2}, Landroidx/recyclerview/widget/c;->d(IILjava/lang/Object;)V
    ...
    .line 19
    iget v8, v10, Landroidx/recyclerview/widget/f$f;->b:I
...
.method public e(Landroidx/recyclerview/widget/RecyclerView$r;)V
    .locals 1

    .line 1
    new-instance v0, Landroidx/recyclerview/widget/b;

    invoke-direct {v0, p1}, Landroidx/recyclerview/widget/b;-><init>(Landroidx/recyclerview/widget/RecyclerView$r;)V

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/f$c;->d(Landroidx/recyclerview/widget/k;)V
