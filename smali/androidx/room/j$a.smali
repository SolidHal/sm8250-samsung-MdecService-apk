...
.method public varargs b([Landroidx/room/s/a;)Landroidx/room/j$a;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iget v4, v2, Landroidx/room/s/a;->startVersion:I
    ...
    iget v2, v2, Landroidx/room/s/a;->endVersion:I
    ...
    invoke-virtual {v0, p1}, Landroidx/room/j$d;->b([Landroidx/room/s/a;)V
...
.method public d()Landroidx/room/j;
    ...
    .line 13
    :cond_4
    iget-object v1, v0, Landroidx/room/j$a;->g:Lb/p/a/c$c;

    if-nez v1, :cond_5

    .line 14
    new-instance v1, Lb/p/a/g/c;

    invoke-direct {v1}, Lb/p/a/g/c;-><init>()V

    iput-object v1, v0, Landroidx/room/j$a;->g:Lb/p/a/c$c;
    ...
    iget-object v1, v0, Landroidx/room/j$a;->q:Ljava/io/File;

    if-eqz v1, :cond_9

    .line 16
    :cond_6
    iget-object v1, v0, Landroidx/room/j$a;->b:Ljava/lang/String;
    ...
    iget-object v2, v0, Landroidx/room/j$a;->p:Ljava/lang/String;

    iget-object v3, v0, Landroidx/room/j$a;->q:Ljava/io/File;

    iget-object v4, v0, Landroidx/room/j$a;->g:Lb/p/a/c$c;

    invoke-direct {v1, v2, v3, v4}, Landroidx/room/p;-><init>(Ljava/lang/String;Ljava/io/File;Lb/p/a/c$c;)V
    ...
    iget-object v8, v0, Landroidx/room/j$a;->g:Lb/p/a/c$c;
    ...
    invoke-direct/range {v5 .. v20}, Landroidx/room/a;-><init>(Landroid/content/Context;Ljava/lang/String;Lb/p/a/c$c;Landroidx/room/j$d;Ljava/util/List;ZLandroidx/room/j$c;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;ZZZLjava/util/Set;Ljava/lang/String;Ljava/io/File;)V
    ...
    .line 23
    invoke-virtual {v2, v1}, Landroidx/room/j;->init(Landroidx/room/a;)V
