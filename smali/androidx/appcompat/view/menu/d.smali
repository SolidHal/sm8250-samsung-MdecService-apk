...
.method static constructor <clinit>()V
    ...
    .line 1
    sget v0, Lb/a/g;->sesl_cascading_menu_item_layout:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->m:Landroidx/appcompat/widget/h0;
    ...
    invoke-direct {v2, p1, v1}, Lb/a/o/d;-><init>(Landroid/content/Context;I)V

    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->c:Landroid/content/Context;
    ...
    .line 20
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->c:Landroid/content/Context;
...
.method private q()Landroidx/appcompat/widget/i0;
    .locals 5
    ...
    .line 2
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->m:Landroidx/appcompat/widget/h0;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/i0;->M(Landroidx/appcompat/widget/h0;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/g0;->w(Landroid/view/View;)V

    .line 6
    iget v1, p0, Landroidx/appcompat/view/menu/d;->o:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/g0;->z(I)V
    ...
    .line 8
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/g0;->B(I)V
...
.method private w(Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-static {v1, v5, v2, v4}, Landroidx/appcompat/view/menu/k;->e(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v2

    .line 8
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->q()Landroidx/appcompat/widget/i0;

    move-result-object v4

    .line 9
    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/g0;->m(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/g0;->z(I)V
    ...
    .line 15
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/i0;->N(Z)V

    .line 16
    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/i0;->K(Ljava/lang/Object;)V
    ...
    .line 20
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/g0;->w(Landroid/view/View;)V
    ...
    .line 31
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/g0;->i(I)V

    .line 32
    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/g0;->F(Z)V

    .line 33
    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/g0;->h(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/g0;->i(I)V
    ...
    .line 39
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/g0;->A(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/d$d;-><init>(Landroidx/appcompat/widget/i0;Landroidx/appcompat/view/menu/g;I)V
    ...
    .line 42
    invoke-virtual {v4}, Landroidx/appcompat/widget/g0;->show()V

    .line 43
    invoke-virtual {v4}, Landroidx/appcompat/widget/g0;->f()Landroid/widget/ListView;
    ...
    .line 46
    sget v1, Lb/a/g;->sesl_popup_menu_header_item_layout:I
...
.method public a()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/i0;
...
.method public dismiss()V
    ...
    .line 5
    iget-object v3, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/i0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/g0;->a()Z
    ...
    .line 6
    iget-object v2, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/i0;

    invoke-virtual {v2}, Landroidx/appcompat/widget/g0;->dismiss()V
...
.method public g(Landroid/view/View;)V
    ...
    .line 4
    invoke-static {p1}, Lb/f/k/t;->t(Landroid/view/View;)I

    move-result p1

    .line 5
    invoke-static {v0, p1}, Lb/f/k/c;->b(II)I
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/g;Z)V
    ...
    .line 8
    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/i0;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/i0;->L(Ljava/lang/Object;)V

    .line 9
    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/i0;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/g0;->x(I)V
...
.method public onDismiss()V
    ...
    .line 3
    iget-object v4, v3, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/i0;

    invoke-virtual {v4}, Landroidx/appcompat/widget/g0;->a()Z
...
.method public updateMenuView(Z)V
    ...
    invoke-static {v0}, Landroidx/appcompat/view/menu/k;->p(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/f;
