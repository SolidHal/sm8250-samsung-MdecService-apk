...
.method private a()Landroidx/appcompat/view/menu/k;
    ...
    invoke-direct/range {v8 .. v14}, Landroidx/appcompat/view/menu/r;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V

    .line 12
    :goto_2
    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->b:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->b(Landroidx/appcompat/view/menu/g;)V

    .line 13
    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->l(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 14
    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->g(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->i(Z)V

    .line 17
    iget v1, p0, Landroidx/appcompat/view/menu/l;->g:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->j(I)V
...
.method private l(IIZZ)V
    ...
    .line 2
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/k;->m(Z)V
    ...
    .line 4
    invoke-static {p4}, Lb/f/k/t;->t(Landroid/view/View;)I

    move-result p4

    .line 5
    invoke-static {p3, p4}, Lb/f/k/c;->b(II)I
    ...
    .line 7
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/k;->k(I)V

    .line 8
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/k;->n(I)V
    ...
    .line 11
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/k;->h(Landroid/graphics/Rect;)V
...
.method public g(Z)V
    ...
    .line 3
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/k;->i(Z)V
