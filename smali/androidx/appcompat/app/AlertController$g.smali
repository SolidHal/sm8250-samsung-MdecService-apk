...
.field public P:Landroidx/appcompat/app/AlertController$g$e;
...
.method private b(Landroidx/appcompat/app/AlertController;)V
    ...
    .line 14
    :goto_1
    iget-object v1, p0, Landroidx/appcompat/app/AlertController$g;->P:Landroidx/appcompat/app/AlertController$g$e;
    ...
    :cond_7
    :goto_2
    iget-object v1, p0, Landroidx/appcompat/app/AlertController$g;->O:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public a(Landroidx/appcompat/app/AlertController;)V
    ...
    .line 4
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/AlertController;->w(Ljava/lang/CharSequence;)V
    ...
    .line 10
    invoke-virtual {p1, v0}, Landroidx/appcompat/app/AlertController;->i(I)I
    ...
    .line 13
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/app/AlertController$g;->i:Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/appcompat/app/AlertController;->q(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;Landroid/graphics/drawable/Drawable;)V

    .line 15
    :cond_7
    iget-object v0, p0, Landroidx/appcompat/app/AlertController$g;->l:Ljava/lang/CharSequence;
    ...
    .line 16
    iget-object v3, p0, Landroidx/appcompat/app/AlertController$g;->l:Ljava/lang/CharSequence;

    iget-object v4, p0, Landroidx/appcompat/app/AlertController$g;->n:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, Landroidx/appcompat/app/AlertController$g;->m:Landroid/graphics/drawable/Drawable;
    ...
    .line 17
    :cond_9
    iget-object v0, p0, Landroidx/appcompat/app/AlertController$g;->o:Ljava/lang/CharSequence;
    ...
    .line 18
    iget-object v3, p0, Landroidx/appcompat/app/AlertController$g;->o:Ljava/lang/CharSequence;

    iget-object v4, p0, Landroidx/appcompat/app/AlertController$g;->q:Landroid/content/DialogInterface$OnClickListener;

    const/4 v5, 0x0

    iget-object v6, p0, Landroidx/appcompat/app/AlertController$g;->p:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/appcompat/app/AlertController;->z(Landroid/view/View;IIII)V

    goto :goto_1

    .line 24
    :cond_e
    invoke-virtual {p1, v2}, Landroidx/appcompat/app/AlertController;->y(Landroid/view/View;)V
