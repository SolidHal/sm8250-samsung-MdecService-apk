...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/x;->k:Landroid/graphics/RectF;
    ...
    sput-object v0, Landroidx/appcompat/widget/x;->l:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private A(Landroid/content/res/TypedArray;)V
    ...
    .line 4
    :cond_0
    invoke-direct {p0, v1}, Landroidx/appcompat/widget/x;->c([I)[I

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/x;->f:[I
...
.method private B()Z
    ...
    .line 2
    :goto_0
    iput-boolean v3, p0, Landroidx/appcompat/widget/x;->g:Z

    if-eqz v3, :cond_1

    .line 3
    iput v2, p0, Landroidx/appcompat/widget/x;->a:I

    .line 4
    iget-object v3, p0, Landroidx/appcompat/widget/x;->f:[I
...
.method private C(ILandroid/graphics/RectF;)Z
    ...
    .line 2
    iget-object v1, p0, Landroidx/appcompat/widget/x;->i:Landroid/widget/TextView;
    ...
    .line 3
    iget-object v2, p0, Landroidx/appcompat/widget/x;->i:Landroid/widget/TextView;
    ...
    .line 5
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/x;->q(I)V

    .line 6
    iget-object p1, p0, Landroidx/appcompat/widget/x;->i:Landroid/widget/TextView;

    sget-object v2, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    const-string v4, "getLayoutAlignment"

    invoke-static {p1, v4, v2}, Landroidx/appcompat/widget/x;->r(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p1, v2, v1}, Landroidx/appcompat/widget/x;->e(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
...
.method private static a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/x;->o(Ljava/lang/String;)Ljava/lang/reflect/Field;
...
.method private f(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-static {v0, v2, v1}, Landroidx/appcompat/widget/x;->r(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/x;->h:Landroid/text/TextPaint;
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/x;->i:Landroid/widget/TextView;
...
.method private g(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    .line 3
    invoke-static {v0, v2, v1}, Landroidx/appcompat/widget/x;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/x;->h:Landroid/text/TextPaint;
...
.method private i(Landroid/graphics/RectF;)I
    ...
    invoke-direct {p0, v3, p1}, Landroidx/appcompat/widget/x;->C(ILandroid/graphics/RectF;)Z
    ...
    .line 4
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/x;->f:[I
...
.method private static o(Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    .line 4
    sget-object v1, Landroidx/appcompat/widget/x;->m:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static p(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    .line 1
    :try_start_0
    sget-object v0, Landroidx/appcompat/widget/x;->l:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 4
    sget-object v1, Landroidx/appcompat/widget/x;->l:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private static r(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/x;->p(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private x(F)V
    ...
    .line 7
    invoke-static {v0}, Landroidx/appcompat/widget/x;->p(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private z()Z
    ...
    .line 6
    :cond_1
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/x;->c([I)[I
...
.method b()V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/appcompat/widget/x;->s()Z
    ...
    .line 6
    invoke-static {v0, v1, v2}, Landroidx/appcompat/widget/x;->r(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 12
    :cond_3
    sget-object v2, Landroidx/appcompat/widget/x;->k:Landroid/graphics/RectF;

    monitor-enter v2

    .line 13
    :try_start_0
    sget-object v3, Landroidx/appcompat/widget/x;->k:Landroid/graphics/RectF;
    ...
    .line 15
    sget-object v0, Landroidx/appcompat/widget/x;->k:Landroid/graphics/RectF;
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/x;->i(Landroid/graphics/RectF;)I
    ...
    .line 18
    invoke-virtual {p0, v1, v0}, Landroidx/appcompat/widget/x;->y(IF)V
...
.method e(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    .line 2
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/appcompat/widget/x;->f(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/x;->h(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    .line 4
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/x;->g(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method k()I
    ...
    .line 1
    iget v0, p0, Landroidx/appcompat/widget/x;->d:F
...
.method l()I
    ...
    .line 1
    iget v0, p0, Landroidx/appcompat/widget/x;->c:F
...
.method q(I)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/x;->h:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/x;->h:Landroid/text/TextPaint;
...
.method t(Landroid/util/AttributeSet;I)V
    ...
    .line 2
    sget p2, Lb/a/j;->AppCompatTextView_autoSizeTextType:I
    ...
    .line 4
    :cond_0
    sget p2, Lb/a/j;->AppCompatTextView_autoSizeStepGranularity:I
    ...
    .line 14
    invoke-direct {p0, v4}, Landroidx/appcompat/widget/x;->A(Landroid/content/res/TypedArray;)V
    ...
    .line 18
    iget p1, p0, Landroidx/appcompat/widget/x;->a:I
    ...
    .line 19
    iget-boolean p1, p0, Landroidx/appcompat/widget/x;->g:Z

    if-nez p1, :cond_8

    .line 20
    iget-object p1, p0, Landroidx/appcompat/widget/x;->j:Landroid/content/Context;
    ...
    .line 24
    :cond_7
    invoke-direct {p0, v1, v3, p2}, Landroidx/appcompat/widget/x;->E(FFF)V

    .line 25
    :cond_8
    invoke-direct {p0}, Landroidx/appcompat/widget/x;->z()Z
...
.method u(IIII)V
    ...
    .line 6
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/x;->E(FFF)V
...
.method v([II)V
    ...
    .line 5
    :cond_0
    iget-object v3, p0, Landroidx/appcompat/widget/x;->j:Landroid/content/Context;
    ...
    :cond_1
    :goto_1
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/x;->c([I)[I

    move-result-object p2

    iput-object p2, p0, Landroidx/appcompat/widget/x;->f:[I
    ...
    .line 12
    :cond_3
    iput-boolean v1, p0, Landroidx/appcompat/widget/x;->g:Z
...
.method w(I)V
    ...
    .line 6
    invoke-direct {p0, v0, p1, v1}, Landroidx/appcompat/widget/x;->E(FFF)V
...
.method y(IF)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/x;->x(F)V
