...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroidx/appcompat/widget/o;->f:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/o;->c:Landroid/graphics/Rect;

    .line 3
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/appcompat/widget/o;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private b(I)Landroid/transition/Transition;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/o;->b:Landroid/content/Context;
...
.method private c(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, v0, p3, p4}, Landroidx/appcompat/widget/v0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/v0;
    ...
    invoke-virtual {p2, p3, p4}, Landroidx/appcompat/widget/v0;->a(IZ)Z

    move-result p3

    invoke-direct {p0, p3}, Landroidx/appcompat/widget/o;->d(Z)V
    ...
    invoke-virtual {p2, p3, p4}, Landroidx/appcompat/widget/v0;->n(II)I

    move-result p3

    invoke-direct {p0, p3}, Landroidx/appcompat/widget/o;->b(I)Landroid/transition/Transition;

    move-result-object p3

    .line 7
    sget v0, Lb/a/j;->PopupWindow_popupExitTransition:I

    invoke-virtual {p2, v0, p4}, Landroidx/appcompat/widget/v0;->n(II)I

    move-result p4

    invoke-direct {p0, p4}, Landroidx/appcompat/widget/o;->b(I)Landroid/transition/Transition;
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/o;->d:Z

    .line 13
    iget-object p1, p0, Landroidx/appcompat/widget/o;->b:Landroid/content/Context;
...
.method private d(Z)V
    ...
    .line 1
    sget-boolean v0, Landroidx/appcompat/widget/o;->f:Z
...
.method public getMaxAvailableHeight(Landroid/view/View;IZ)I
    ...
    .line 2
    invoke-static {p1, v0}, Lb/n/h/f;->c(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 3
    iget-boolean p3, p0, Landroidx/appcompat/widget/o;->d:Z

    if-eqz p3, :cond_1

    .line 4
    iget-object p3, p0, Landroidx/appcompat/widget/o;->b:Landroid/content/Context;
    ...
    iget v2, p0, Landroidx/appcompat/widget/o;->e:I
    ...
    .line 9
    invoke-virtual {p0}, Landroidx/appcompat/widget/o;->a()Z
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/o;->c:Landroid/graphics/Rect;

    invoke-virtual {p2, p3}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    .line 16
    iget-object p2, p0, Landroidx/appcompat/widget/o;->c:Landroid/graphics/Rect;
